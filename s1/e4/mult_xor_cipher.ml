...
let () =
  let input = "0e3647e8592d35514a081243582536ed3de6734059001e3f535ce6271032" in
  let global_min_score_bytes = ref (bytes_of_hex_string input) in
  let ic = open_in "s1/e4/data" in
  try
    while true do
      ...
      if score !min_score_bytes < score !global_min_score_bytes then global_min_score_bytes := !min_score_bytes
    done
  with End_of_file -> close_in ic;
  pp !global_min_score_bytes;

(* N o w   t h a t   t h e   p a r t y   i s   j u m p i n g ?  *)